...
The entrypoint file for your npm package, will most likely just export your plugin registration from the `dist/src` folder.

### `tsconfig.js`

The boilerplate settings for compiling Typescript files from src folder to dist folder.
